...
public enum Config {
    ...
    public enum History {
        ...
        /// Метка времени в имени отложенного испорченного индекса. Двоеточий
        /// в имени файла быть не может, поэтому время слитно.
        public static let brokenIndexDateFormat = "yyyy-MM-dd-HHmmss"
        /// Пометка в имени файла, отложенного из-за непрочитанного индекса.
        public static let brokenIndexSuffix = "broken"
